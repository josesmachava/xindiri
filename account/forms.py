...
from .models import User, Business, SandboxAPI, ProductionAPI
...
class BusinessSignUpForm(UserCreationForm):
    ...
    def save(self):
        ...
        sandbox_api = SandboxAPI.objects.create(user=user)
        production_api = ProductionAPI.objects.create(user=user)
